...
func _enter_tree() -> void:
	...
	_create_button("Add Base Platform", "uid://b15n3doltmgcf", "uid://bcyhm7y82lmvw")
	_create_button("Add Moving Platform", "uid://boxcy5m6k1suf", "uid://bcmwsc2euqk5d")
	_create_button("Add Break Platform", "uid://bywrwg0oldeq1", "uid://n11264tnbg8u")
	_create_button("Add a Triggered Moving Platform", "uid://dcgm78rrbpfka", "uid://ddskyllmr3iqs")
	_create_button("Add Prop", "uid://diub5mlygnsif", "uid://btt4o11n3wkra")
	_create_button("Add Hazard", "uid://b3341ujv0qhec", "uid://pgxsnahlr65x")
	_create_button("Add a Fan", "uid://cct6mp33cxj0x", "uid://d0r5t0bqtpb4x")
	_create_button("Add Physical Button", "uid://de44hopdiag5t", "uid://dgi525jl7yhcc")
	_create_button("Add Lever", "uid://cjcf8655lb6rm", "uid://5x1gs2jclvch")
