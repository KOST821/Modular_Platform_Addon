...
The addon is based on 2 scripts that all nodes extend, [Platform](PlatformFramework/BaseScripts/PlatformBaseScript.gd) and [Prop or Hazard](PlatformFramework/BaseScripts/PropOrHazard.gd), that way most of the platforms and props are in need of the same setup!
